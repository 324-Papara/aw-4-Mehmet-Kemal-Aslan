...
namespace Para.Api.Controllers
{
    ...
    public class AccountTransactionsController : ControllerBase
    {
        ...
        [Authorize(Roles = "admin")]
        public async Task<ApiResponse<AccountTransactionResponse>> Get([FromRoute] int AccountTransactionId)
        {
        ...
        [Authorize(Roles = "admin")]
        public async Task<ApiResponse> Put(int AccountTransactionId, [FromBody] AccountTransactionRequest value)
        {
        ...
        [Authorize(Roles = "admin")]
        public async Task<ApiResponse> Delete(int AccountTransactionId)
        {
