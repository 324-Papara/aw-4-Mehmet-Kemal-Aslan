...
namespace Para.Api.Controllers
{
    ...
    public class AccountsController : ControllerBase
    {
        ...
        [HttpGet("{AccountId}")]
        //[Authorize(Roles = "admin")]
        public async Task<ApiResponse<AccountResponse>> Get([FromRoute] int AccountId)
        {
        ...
        [HttpPut("{AccountId}")]
        //[Authorize(Roles = "admin")]
        public async Task<ApiResponse> Put(int AccountId, [FromBody] AccountRequest value)
        {
